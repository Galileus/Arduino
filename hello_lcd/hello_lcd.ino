...
// 3S LiFePO4
const int lifepo_points = 5;
float lifepo_voltage[lifepo_points] = {9.0, 11.0, 12.5, 13.3, 13.8};
int lifepo_soc[lifepo_points] = {0,25,50,75,100};
...
void loop() {
  ...
  if (lastButtonState == HIGH && buttonState == LOW) {
    ...
    if (mode == 1) lcd.print("LiFePO4 3S");
  ...
  if (mode == 1) Serial.print("LiFePO4 3S");
